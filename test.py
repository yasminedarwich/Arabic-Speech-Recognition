...
# Define a function to set the style using CSS
def set_custom_style():
    custom_style = """
    <style>
    body {
        background-color: #6FC0D3;  /* Crayola blue background */
        color: #FFFFFF;
    }
    ...
    .stButton > button {
        background-color: #3A90A2;  /* Crayola blue button color */
        color: #FFFFFF;
    }
    ...
    h1, h2, h3 {
        color: #3A90A2;  /* Crayola blue headers */
    }
    .st-icon {
        color: #3A90A2 !important;  /* Crayola blue icons */
    }
    </style>
    """
...
# Define a function to display the "Transcription" page
def show_transcription_page():
    st.title("Audio Transcription")
    # Add your transcription page content here
...
current_page = "Home💫"
current_page = st.sidebar.selectbox("Select a Page", ["Home💫", "Transcription🎤", "Analytics📊"])
...
if current_page == "Home💫":
    ...
    st.markdown(
        """
        This is the introduction page for my transcription app.
        You can find the transcription functionality by clicking the button below.
        """
    )
    ...
    if st.button("Go to Transcription Page"):
        current_page = "Transcription🎤"

elif current_page == "Transcription🎤":
